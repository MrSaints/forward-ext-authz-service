...
// Modified from https://github.com/projectcontour/contour-authserver/blob/f88f17864d16b053e1387a8778a13bfcb511a5e5/pkg/auth/convert.go
...
func (r *Request) FromV3(c *CheckRequestV3) (*Request, error) {
	pathURL, err := url.Parse(c.GetAttributes().GetRequest().GetHttp().GetPath())
	if err != nil {
		return nil, err
	}
